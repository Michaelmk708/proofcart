...
export const canisterId = process.env.CANISTER_ID_NFT_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nft_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nft_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nft_canister.did.js")._SERVICE>}
 */
export const nft_canister = createActor(canisterId);
